...
isAdultPresent = devs.some((dev) => {
  let age = 2025 - dev.year; //subtract year of birth from current year to determine age
  return age >= 18;
});
...
totalYearsLived = inventors.reduce((acc, inventor) => {
  let lifespan = inventor.passed - inventor.year; //calculate age
  return acc + lifespan;
}, 0);
